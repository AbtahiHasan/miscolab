...
const Footer = () => {
    return (
      ...
      <footer className="relative z-10 bg-[#f9f4f4] mt-[140px] pt-20 pb-10 lg:pt-[120px]  lg:pb-20 px-3">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <Link href="#" className="mb-6 inline-block max-w-[160px] text-3xl font-bold">
                Miscolab
                </Link>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-body-color text-base">&copy; Miscolab</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full text-center text-lg font-bold  mx-auto">
                <hr className='my-5' />
				...
				All Right Reserved. Developed By MiscoLab
			</div>
      </footer>
